    ...
    _drawBoard: function () {
        ...
        self.data.chessBoardColumns.forEach(function (col, colIndex) {
            self.data.chessBoardRows.forEach(function (row, rowIndex) {
                // color of the new tile is easily determined; if row and column index are both even or odd, then it's white; else it's blue
                let color = (rowIndex % 2 === colIndex % 2 ? "white" : "blue");
...
AFRAME.registerComponent("piece", {
    ...
    init: function () {
        ...
        // use the mixins : [white|blue][pawn|rook|knight|bishop|queen|king] piece
